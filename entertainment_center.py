...
daredevil_netflix = media.Movie(
        ...
        "http://ia.media-imdb.com/images/M/MV5BMTgyMjU0Mzg5Nl5BMl5BanBnXkFtZTgwMTg3MDYyNTE@._V1_SX640_SY720_.jpg",
        "https://www.youtube.com/watch?v=jAy6NJ_D5vU")

daredevil = media.Movie(
        "Daredevil",
...
spider_man2 = media.Movie(
        ...
        "https://www.youtube.com/watch?v=SCLTJJZ8gas")
...
elektra = media.Movie(
        ...
        "https://upload.wikimedia.org/wikipedia/en/2/21/Elektra_teaser.jpg",
        "https://www.youtube.com/watch?v=O0HDDJKrxY8")
...
ghost_rider = media.Movie(
        ...
        "https://www.youtube.com/watch?v=KSmYi4lhfrM")

catwoman = media.Movie(
        "Catwoman",
...
x2 = media.Movie(
        ...
        "https://www.youtube.com/watch?v=voxI4h7Jzmo")

x_men_last_stand = media.Movie(
        ...
        "https://www.youtube.com/watch?v=dv-7FY5gm0w")
...
movies = [deadpool, daredevil_netflix, daredevil, spider_man, spider_man2, spider_man3, avengers, avengers2, ironman, ironman2, ironman3, captain_america, captain_america2, thor, thor2, ant_man, ghost_rider, x_men, x2, x_men_last_stand]
